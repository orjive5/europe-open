          ...
          <Controller
            ...
            render={({ field: { onChange, onBlur, value }, fieldState }) => (
              <div>
                ...
                <FormDescription>
                  Soloists - we recommend a screenshot of part of the document where only the first name, last name, date of birth and title of the document are visible,
                  Ensembles - a list of participants indicating their dates of birth.
                </FormDescription>

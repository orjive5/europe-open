  ...
  return (
    <main className="flex flex-col md:items-center sm:my-8 gap-8">
      <section className="w-full flex flex-col justify-center items-center gap-8">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col md:flex-row justify-center items-end gap-4 w-full sm:w-10/12 md:w-auto">
            <FormField
            ...
            />
            <Button className="flex gap-2 w-full md:w-[300px]" type="submit">
              Search
              <Search />
            </Button>
          </form>
